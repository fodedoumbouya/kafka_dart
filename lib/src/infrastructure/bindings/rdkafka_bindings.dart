...
/// Generated bindings for librdkafka
class RdkafkaBindings {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  RdkafkaBindings(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  RdkafkaBindings.fromLookup(
  ...
  rd_kafka_resp_err_t rd_kafka_header_add(
    ...
    Dart__ssize_t name_size,
    ffi.Pointer<ffi.Void> value,
    Dart__ssize_t value_size,
  ) {
...
typedef __kernel_sighandler_tFunction = ffi.Void Function(ffi.Int);
typedef Dart__kernel_sighandler_tFunction = void Function(int);
typedef __kernel_sighandler_t
    = ffi.Pointer<ffi.NativeFunction<__kernel_sighandler_tFunction>>;
typedef __kernel_key_t = ffi.Int;
typedef Dart__kernel_key_t = int;
typedef __kernel_mqd_t = ffi.Int;
typedef Dart__kernel_mqd_t = int;
typedef __kernel_old_uid_t = ffi.UnsignedShort;
typedef Dart__kernel_old_uid_t = int;
typedef __kernel_old_gid_t = ffi.UnsignedShort;
typedef Dart__kernel_old_gid_t = int;
typedef __kernel_old_dev_t = ffi.UnsignedLong;
typedef Dart__kernel_old_dev_t = int;
typedef __kernel_long_t = ffi.Long;
typedef Dart__kernel_long_t = int;
typedef __kernel_ulong_t = ffi.UnsignedLong;
typedef Dart__kernel_ulong_t = int;
typedef __kernel_ino_t = __kernel_ulong_t;
typedef __kernel_mode_t = ffi.UnsignedInt;
typedef Dart__kernel_mode_t = int;
typedef __kernel_pid_t = ffi.Int;
typedef Dart__kernel_pid_t = int;
typedef __kernel_ipc_pid_t = ffi.Int;
typedef Dart__kernel_ipc_pid_t = int;
typedef __kernel_uid_t = ffi.UnsignedInt;
typedef Dart__kernel_uid_t = int;
typedef __kernel_gid_t = ffi.UnsignedInt;
typedef Dart__kernel_gid_t = int;
typedef __kernel_suseconds_t = __kernel_long_t;
typedef __kernel_daddr_t = ffi.Int;
typedef Dart__kernel_daddr_t = int;
typedef __kernel_uid32_t = ffi.UnsignedInt;
typedef Dart__kernel_uid32_t = int;
typedef __kernel_gid32_t = ffi.UnsignedInt;
typedef Dart__kernel_gid32_t = int;
typedef __kernel_size_t = __kernel_ulong_t;
typedef __kernel_ssize_t = __kernel_long_t;
typedef __kernel_ptrdiff_t = __kernel_long_t;
...
typedef __kernel_time_t = __kernel_long_t;
typedef __kernel_time64_t = ffi.LongLong;
typedef Dart__kernel_time64_t = int;
typedef __kernel_clock_t = __kernel_long_t;
typedef __kernel_timer_t = ffi.Int;
typedef Dart__kernel_timer_t = int;
typedef __kernel_clockid_t = ffi.Int;
typedef Dart__kernel_clockid_t = int;
typedef __kernel_caddr_t = ffi.Pointer<ffi.Char>;
typedef __kernel_uid16_t = ffi.UnsignedShort;
typedef Dart__kernel_uid16_t = int;
typedef __kernel_gid16_t = ffi.UnsignedShort;
typedef Dart__kernel_gid16_t = int;
...
final class UnnamedUnion2 extends ffi.Union {
  ...
  external UnnamedStruct3 header;
...
const int MSG_OOB$1 = 1;

const int MSG_PEEK$1 = 2;

const int MSG_DONTROUTE$1 = 4;

const int MSG_CTRUNC$1 = 8;

const int MSG_PROXY$1 = 16;

const int MSG_TRUNC$1 = 32;

const int MSG_DONTWAIT$1 = 64;

const int MSG_EOR$1 = 128;

const int MSG_WAITALL$1 = 256;

const int MSG_FIN$1 = 512;

const int MSG_SYN$1 = 1024;

const int MSG_CONFIRM$1 = 2048;

const int MSG_RST$1 = 4096;

const int MSG_ERRQUEUE$1 = 8192;

const int MSG_NOSIGNAL$1 = 16384;

const int MSG_MORE$1 = 32768;

const int MSG_WAITFORONE$1 = 65536;

const int MSG_BATCH$1 = 262144;

const int MSG_ZEROCOPY$1 = 67108864;

const int MSG_FASTOPEN$1 = 536870912;

const int MSG_CMSG_CLOEXEC$1 = 1073741824;

const int SCM_RIGHTS$1 = 1;

const int __BITS_PER_LONG = 64;

const int __BITS_PER_LONG_LONG = 64;
...
const int SO_DEVMEM_LINEAR = 78;

const int SCM_DEVMEM_LINEAR = 78;

const int SO_DEVMEM_DMABUF = 79;

const int SCM_DEVMEM_DMABUF = 79;

const int SO_DEVMEM_DONTNEED = 80;

const int SCM_TS_OPT_ID = 81;

const int SO_RCVPRIORITY = 82;
...
const int SHUT_RD$1 = 0;

const int SHUT_WR$1 = 1;

const int SHUT_RDWR$1 = 2;

const int LIBRDKAFKA_TYPECHECKS = 1;

const int RD_KAFKA_VERSION = 33620479;
